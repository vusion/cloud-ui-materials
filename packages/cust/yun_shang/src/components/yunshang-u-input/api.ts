...
namespace extensions.yun_shang.viewComponents {
  ...
  export class YunshangUInput extends ViewComponent {
    ...
    value: YunshangUInputOptions['value'];
    @Prop({
      title: '禁用',
    })
    ...
    clear(): void {}
    constructor(options?: Partial<YunshangUInputOptions>) {
      super();
    }
  }
  export class YunshangUInputOptions extends ViewComponentOptions {
    @Prop({
      title: '最小长度',
      setter: {
    ...
    onBeforeInput: (event: { value: nasl.core.String; oldValue: nasl.core.String }) => any;
    @Event({
      title: '输入时',
      description: '输入时触发。',
    })
    ...
    onBeforeClear: (event: { value: nasl.core.String; oldValue: nasl.core.String }) => any;
    @Event({
      title: '清空后',
      description: '清空后触发。',
    })
    onClear: (event: { value: nasl.core.String; oldValue: nasl.core.String }) => any;
    @Event({
      title: '点击前缀图标',
