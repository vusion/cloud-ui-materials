...
export default {
    ...
    methods: {
                ...
                (AMap) => {
                    ...
                    this.pointStore = createMapMarkerStore({
                        onMarkClick: (e) => {
                            ...
                            if (!this.hasInfoWindow) return;
                            this.selectedPoint = extData;
                            this.selectedPointDiv = e.target.dom;
                            this.$nextTick(() => {
                                this.updateInfoWindowPos();
                            });
                        },
        ...
        updateInfoWindowPos() {
            if (
                !this.selectedPointDiv ||
                !this.$refs.infoWindow ||
                !this.$refs.infoWindowArrow
            ) {
                return;
            }
            computePosition(this.selectedPointDiv, this.$refs.infoWindow, {
                middleware: [
                    offset(),
                    shift(),
                    flip(),
