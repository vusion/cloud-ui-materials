...
<template>
    <cw-antd-auto-complete valueField="name" :value="value" :data-source="load"></cw-antd-auto-complete>
</template>
<script>
export default {
    data(){
...
<template>
    <cw-antd-auto-complete valueField="" :value="value" :data-source="load"></cw-antd-auto-complete>
</template>
<script>
export default {
    data(){
