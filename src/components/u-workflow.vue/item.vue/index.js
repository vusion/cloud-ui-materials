...
export const UWorkflowItem = {
    ...
    //     !this.parentVM && this.$contact((vm) => vm.$options.name === 'u-workflow' || vm.$options.name === 'u-workflow-item', (parentVM) => {
    ...
    // },
    // destroyed() {
    //     this.$contact((vm) => vm.$options.name === 'u-workflow' || vm.$options.name === 'u-workflow-item', (parentVM) => {
