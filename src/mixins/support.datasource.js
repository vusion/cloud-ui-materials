export default {
	...
	methods: {
		...
		normalizeDataSource(dataSource, multiple) {
			...
			} else if (Object.prototype.toString.call(dataSource) === '[object Object]' && Array.isArray(dataSource.list)) {
				final.data = dataSource.list;
			} else if (Object.prototype.toString.call(dataSource) === '[object Object]' && dataSource.content) {
