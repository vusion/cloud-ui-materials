...
.showButton::before {
    display: block;
    content: '';
    background-image: url('data:image/svg+xml;base64,');
    background-size: 8px;
    width: 8px;
    height: 8px;
    position: absolute;
...
.showButton:hover::before {
    background-image: url('data:image/svg+xml;base64,');
}
