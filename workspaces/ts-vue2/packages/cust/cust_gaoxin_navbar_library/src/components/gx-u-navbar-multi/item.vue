...
<script>
import { MSinglexItem } from "@lcap-ui/src/components/m-singlex.vue";
...
export default {
  ...
  methods: {
    onClick(e) {
      if (this.disabled || this.parentVM.readonly || this.parentVM.disabled || this.groupVM && this.groupVM.disabled) return e.preventDefault();
