<template>
  <div>
    <aux-u-cascader :emptyValueIsNull="true" :dataSource="[]"></aux-u-cascader>
    <aux-u-cascader :emptyValueIsNull="true" :dataSource="dataSource"></aux-u-cascader>
  </div>
</template>

<script>
import AuxUCascader from '@/components/aux-u-cascader';
export default {
  components: {
    AuxUCascader,
  },
