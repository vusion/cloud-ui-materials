import { deepClone } from "@lcap-ui/src/utils/deep-clone";
import { createNamespace, isObject, _get, isDef } from "@lcap-ui/src/utils";
import { range } from "@lcap-ui/src/utils/format/number";
import { preventDefault } from "@lcap-ui/src/utils/dom/event";
import { TouchMixin } from "@lcap-ui/src/mixins/touch";
...
export default createComponent({
  ...
  methods: {
    ...
    genOptions() {
      ...
      return this.options.map((option, index) => {
        ...
        return <li {...data} vusion-slot-name="option">
            {this.slots('option', {
            ...option,
            item: option
  ...
  render() {
    ...
    return <div class={[bem(), this.className]}>
        <ul ref="wrapper" style={wrapperStyle} class={bem('wrapper')} onTransitionend={this.onTransitionEnd}>
          {this.genOptions()}
        </ul>
      </div>;
  }
