<template>
  <div :class="$style.root">
    <u-modal
      :title="this.cropConfig.title || '图片裁剪'"
      :visible="visible"
      size="auto"
      :maskClose="false"
      :mode="false"
      :class="$style.cropperModal"
    >
      <div :class="$style.cropperWrapper">
        ...
        <div :class="$style.previewWrapper">
          ...
          <div
            v-if="cropConfig.previewShape === 'circle'"
            :style="previewStyle1"
            :class="$style.previewBoxCircle"
          >
