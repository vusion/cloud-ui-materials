...
namespace extensions.cw_eu_extend_cu_library.viewComponents {
  ...
  @ExtensionComponent({
    // replaceNaslUIComponent: "USelect",
    type: "pc",
    show: true,
    ideusage: {
      "idetype": "container",
      ...
      "slotWrapperInlineStyle": {
        "option": "display: inline-block; width: calc(100% - 32px);"
      },
      "dataSource": {
        "dismiss": "!this.getAttribute('dataSource')",
        "display": 3,
        "loopRule": "nth-last-child(-n+2)",
        "loopElem": "div[class^='u-select_item']"
      },
      "translateBindingProperty": ["placeholder"],
      "additionalAttribute": {
        "autofocus": "\"false\"",
        "appendTo": "\"body\""
      }
  ...
  export class USelect<T, V, P extends nasl.core.Boolean, M extends nasl.core.Boolean, C> extends ViewComponent {
    ...
    item: T, inFirst: nasl.core.Boolean = false): void {}
  ...
  export class USelectOptions<T, V, P extends nasl.core.Boolean, M extends nasl.core.Boolean, C> extends ViewComponentOptions {
    ...
    slotDefault: () => Array<nasl.ui.USelectItem<T, V> | nasl.ui.USelectGroup<T, V> | nasl.ui.USelectDivider>;
    @Slot({
      title: '选项内容',
      description: '自定义选项内容'
    })
    ...
    slotRenderFooter: () => Array<nasl.ui.ViewComponent>;
  }
  @ExtensionComponent({
    type: "pc",
    show: true,
    ideusage: {
      ...
      "disableSlotAutoFill": [{
        "slot": "default",
        "expression": "this.getAttribute('text')?.value"
      }]
    }
  })
  @Component({
  ...
  export class USelectGroupOptions<T, V> extends ViewComponentOptions {
    ...
    slotDefault: () => Array<nasl.ui.USelectItem<T, V>>;
    @Slot({
      title: '标题',
      description: '自定义标题文本。'
    })
