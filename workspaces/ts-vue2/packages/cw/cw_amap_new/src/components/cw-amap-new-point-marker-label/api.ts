...
namespace extensions.cw_amap_new.viewComponents {
  ...
  export class CwAmapNewPointMarkerLabel<T, V> extends ViewComponent {
    constructor(options?: Partial<CwAmapNewPointMarkerLabelOptions<T, V>>) {
      super();
    }
  ...
  export class CwAmapNewPointMarkerLabelOptions<T, V> extends ViewComponentOptions {
    @Prop({
      group: '数据属性',
      title: '数据源',
    ...
    collision: nasl.core.Boolean = true;
    ...
    allowCollision: nasl.core.Boolean = true;
