...
namespace extensions.cw_amap_new.viewComponents {
  ...
  export class CwAmapNewPointMarkerCluster<T, V> extends ViewComponent {
    constructor(options?: Partial<CwAmapNewPointMarkerClusterOptions<T, V>>) {
      super();
    }
  ...
  export class CwAmapNewPointMarkerClusterOptions<T, V> extends ViewComponentOptions {
    @Prop({
      group: '数据属性',
      title: '数据源',
