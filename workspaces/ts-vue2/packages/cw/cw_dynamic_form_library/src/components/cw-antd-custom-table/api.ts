...
namespace extensions.cw_dynamic_form_library.viewComponents {
  ...
  export class CwAntdCustomTable extends ViewComponent {
    constructor(options?: Partial<CwAntdCustomTableOptions>) {
      super();
    }
  }

  export class CwAntdCustomTableOptions extends ViewComponentOptions {
    @Prop({
      title: '值',
      description: '需要传入的值',
      setter: {
